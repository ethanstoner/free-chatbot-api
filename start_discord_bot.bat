@echo off
REM This script starts the Discord bot through WSL
...
wsl.exe bash -c "cd '/home/ethan/cursor projects/free-chatbot-api' && source venv/bin/activate && python discord_bot.py"
